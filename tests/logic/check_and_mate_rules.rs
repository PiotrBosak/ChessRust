mod check_and_mate_rules {
    ...
    use chessTUI::{is_king_mated, Board, Color, File, Position, Rank};
    ...
    pub fn white_king_should_be_checked_by_queen_on_a_5() -> Result<(), String> {
        ...
        let after_white_pawn = board
            ...
            .ok_or("error 1")?;
        let after_black_pawn = after_white_pawn
            .make_move(
                &Position::new(File::C, Rank::Seven),
                &Position::new(File::C, Rank::Five),
            )
            .ok_or("error 2")?;
        let after_queen = after_black_pawn
            .make_move(
    ...
    pub fn white_king_is_mated_by_fools_mate() -> Result<(), String> {
        ...
        let second = first
            .make_move(
                &Position::new(File::E, Rank::Seven),
                &Position::new(File::E, Rank::Five),
            )
            .ok_or("error 2")?;
        let third = second
            .make_move(
                &Position::new(File::G, Rank::Two),
